	 ...
	 if(isset($_POST["btnSubmit"]))
			{
			   ...
			   $sql = "INSERT INTO `tbladvertisement` (`advertisementID`, `productName`, `description`, `publish`, `imagePath`, `category`, `contactNumber`, `email`) VALUES (NULL, '".$productname."', '".$description."', '".$status."', '".$image."', '".$category."', '".$contactNumber."', '".$_SESSION["userName"]."');";
