...
<body>
    <h2>Trash to Cash Sign up form</h2>
<div class="container" id="container">
	<div class="form-container sign-up-container">
		<form action="RegistrationHandler.php" method="post">
			...
			<input type="submit" value="Sign Up" name="btnSubmit" onClick="checkPassword()">
            <a href="home.html">TrashToCash</a>
		</form>
	...
	<div class="form-container sign-in-container">
		<form action="loginHandler.php" method="post">
            ...
            <br>
            <a href="home.html">Back to TrashToCash</a>
        </form>
